...
class Stagers:
    ...
    def generate_launcher(self, listenerName, useWindowHandler='False', language=None, encode=True, obfuscate=False, obfuscationCommand="", userAgent='default', proxy='default', proxyCreds='default', stagerRetries='0', safeChecks='true'):
        """
